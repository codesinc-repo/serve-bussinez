...
import contentservice_3 from "./2024-08-01-content-writing-services-3.json"

export const ContentServices3 = () => {
  ...
  useEffect(() => {
    if (contentservice_3) {
      setData(contentservice_3);
      if (contentservice_3.sections) {
        setSections(contentservice_3.sections);
      } else {
  ...
  return (
    <>
      <main style={{ position: 'relative' }}>
        ...
        <ServicesBanner
          subtitle=""
          title="Professional Product Description Writing Services"
          ...
          className="col-lg-4"
          col_1_title="Custom Product Descriptions"
          ...
          col_3_title="Engagement Enhancement"
          ...
          imgUrl="/images/content-web2.jpg"
        />
        ...
        <div className="container-services p-5">
          <div className="row">
            <div className="col-lg-6">
              <img src="/images/content-web3.jpg" alt="Image" width="580px" />
            </div>
            <div className="col-lg-6">
              {/* <p>Reliable</p> */}
              <h3>Professional Storytelling Services</h3>
              <p>
        ...
        <ServicesBanner
          ...
          className="col-lg-4"
          col_1_title="Custom Ghostwriting"
          ...
          col_3_title="Confidentiality Assurance"
          ...
          imgUrl="/images/content-web4.jpg"
        />
        ...
        <div className="container-services p-5">
          <div className="row">
            <div className="col-lg-6">
              <img src="/images/content-web5.jpg" alt="Image" width="580px" />
            </div>
            <div className="col-lg-6">
              {/* <p>Reliable</p> */}
              <h3>
                Professional Storytelling Services</h3>
              <p>
                We offer a wide range of services including email marketing
                campaigns tailored to boost your audience engagement. Our team
                of expert marketers is dedicated to delivering high-quality
        ...
        <div className="content-solution">
          <div className="container text-center">
            ...
            <div className="row">
              <div className="col-lg-4 text-start column sm-mt-5">
