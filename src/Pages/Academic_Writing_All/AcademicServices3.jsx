...
import AcademicServices_3 from "./2024-08-01-academic-writing-services-3.json"

export const AcademicServices3 = () => {
  ...
  useEffect(() => {
    if (AcademicServices_3) {
      setData(AcademicServices_3);
      if (AcademicServices_3.sections) {
        setSections(AcademicServices_3.sections);
      } else {
  ...
  return (
    <>
      ...
      <main style={{ position: 'relative' }}>
        ...
        <ServicesBanner
          subtitle=""
          title="Professional Annotated Bibliography Services"
          ...
          className="col-lg-4"
          col_1_title="Custom Annotated Bibliographies"
        ...
        <div className="container-services p-5">
          <div className="row">
            <div className="col-lg-6">
              <img data-aos="zoom-out" src="/images/academic6.jpg" alt="Professional Research Paper Services" width="580px" />
            </div>
            <div className="col-lg-6">
              {/* <p>Reliable</p> */}
              <h3 data-aos="fade-up">Professional Book Review Services</h3>
        ...
        {/* Annual Reports */}
        <ServicesBanner
          title="Professional Lab Report Services"
          ...
          className="col-lg-4"
          col_1_title="Custom Lab Reports"
        ...
        <div className="container-services p-5">
          <div className="row">
            <div className="col-lg-6">
              <img data-aos="zoom-out" src="/images/academic9.jpg" alt="Professional Research Paper Services" width="580px" />
            </div>
            <div className="col-lg-6">
              {/* <p>Reliable</p> */}
              <h3 data-aos="fade-up">Professional Presentation or Speech Writing Services</h3>
              <p data-aos="slide-left" data-aos-delay="300" data-aos-duration="1000">
                We offer a wide range of writing services including research
                papers tailored to meet your academic needs. Our team of expert
                writers is dedicated to delivering high-quality research papers
              ...
              <div className="row">
                <div className="col-lg-4" data-aos="zoom-in" data-aos-delay="300" data-aos-duration="1000">
                  <h5 >Custom Presentations or Speeches</h5>
                  <p>
                    Get professionally written research papers tailored to your
                    specific requirements and academic standards.
                  </p>
