...
import academicservice from "./2024-08-01-academic-writing-services-1.json"
...
export const AcademicServices1 = () => {
  ...
  useEffect(() => {
    if (academicservice) {
      setData(academicservice);
      if (academicservice.sections) {
        setSections(academicservice.sections);
      } else {
        ...
        <div className="container-services p-5">
          <div className="row">
            <div className="col-lg-6">
              <img data-aos="zoom-out" src="/images/academic1.jpg" alt="Professional Research Paper Services" width="580px" />
            </div>
            <div className="col-lg-6">
              {/* <p>Reliable</p> */}
              <h3 data-aos="fade-up">Professional Research Paper Services</h3>
